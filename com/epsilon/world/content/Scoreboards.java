...
public class Scoreboards {
	...
	public static void init() {
		TOP_PKERS = new Scoreboard("Epsilon's Top Pkers", "top-pkers.txt") {
			@Override
		...
		TOP_KILLSTREAKS = new Scoreboard("Epsilon's Top Killstreaks", "top-killstreaks.txt") {
			@Override
			public void resort(ArrayList<ScoreboardEntry> entries) {
		...
		TOP_ACHIEVER = new Scoreboard("Epsilon's Top Achiever", "top-achievers.txt")  {
			@Override
			public void resort(ArrayList<ScoreboardEntry> entries) {
				Scoreboards.resort(entries, "integer");
			}
		...
		TOP_TOTAL_EXP = new Scoreboard("Epsilon's Top Total Exp", "top-exp.txt")  {
			@Override
			public void resort(ArrayList<ScoreboardEntry> entries) {
