...
public class Artifacts {
	 ...
	 * @param RegularPlayer player		Player who has killed Player o
	 * @param RegularPlayer o			Player who has been killed by Player player
	 */
	public static void handleDrops(Player killer, Player death, boolean targetKill) {
		if(killer.getGameMode() != GameMode.LEGEND)
			return;
