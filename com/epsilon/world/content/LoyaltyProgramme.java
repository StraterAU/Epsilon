...
public class LoyaltyProgramme {
	...
	public enum LoyaltyTitles {
		...
		BARON(10000, 43075, -22456) {
			@Override
			boolean canBuy(Player p, boolean sendMessage) {
				return true;
			}
		},
		BARONESS(10000, 43079, -22452) {
			@Override
			boolean canBuy(Player p, boolean sendMessage) {
				return true;
			}
		},
		SIR(8000, 43083, -22464) {
			@Override
			boolean canBuy(Player p, boolean sendMessage) {
				return true;
			}
		},
		LADY(8000, 43087, -22460) {
			@Override
			boolean canBuy(Player p, boolean sendMessage) {
				return true;
			}
	...
	public static void incrementPoints(Player player) {
		double pts = player.getHighestRights().getLoyaltyPointsGainModifier();
		...
		player.getPacketSender().sendString("@or2@Loyalty Points: @or1@" +totalPoints, PlayerPanel.getLineId(15));
