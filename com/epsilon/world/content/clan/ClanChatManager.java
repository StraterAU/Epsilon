...
public class ClanChatManager {
	...
	public static void setName(Player player, String newName) {
		...
		if(clan.getLastAction().elapsed(5000) || player.getHighestRights().isStaff()) {
	...
	public static void handleMemberOption(Player player, int index, int menuId) {
		...
		case 3:
			...
			if(player.getCurrentClanChat().getLastAction().elapsed(5000) || player.getHighestRights().isStaff()) {
