package com.epsilon.world.content.skill.impl.construction;
...
import com.epsilon.world.content.skill.impl.construction.ConstructionData.Butlers;
import com.epsilon.world.content.skill.impl.construction.ConstructionData.Furniture;
import com.epsilon.world.content.skill.impl.construction.ConstructionData.HotSpots;
...
import com.epsilon.world.content.skill.impl.construction.ConstructionData.Portals;
import com.epsilon.world.content.skill.impl.construction.ConstructionData.RoomData;
...
public class Construction {
	...
	public static String hasReqs(Player p, Furniture f, HotSpots hs) {
		...
		if (p.hasRights(PlayerRights.DEVELOPER))
			return null;
	...
	public static boolean buildActions(Player p, Furniture f, HotSpots hs) {
		...
		if (p.getExperienceMode() == ExperienceModes.EXTREME)
			p.getSkillManager().addExperience(Skill.CONSTRUCTION, f.getXP() * 100);
			...
			if (p.getExperienceMode() == ExperienceModes.IMMORTAL)
				p.getSkillManager().addExperience(Skill.CONSTRUCTION, f.getXP() * 10);
			...
			if (p.getExperienceMode() == ExperienceModes.IRONMAN)
				p.getSkillManager().addExperience(Skill.CONSTRUCTION, f.getXP() * 22);
			if (p.getExperienceMode() == ExperienceModes.HARDCOREIRONMAN)
				p.getSkillManager().addExperience(Skill.CONSTRUCTION, f.getXP() * 4);
