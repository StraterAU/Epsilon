				...
				public void stop() {
					...
					if(Agility.passedAllObstacles(player)) {
						if(player.getGameMode() == GameMode.EXTREME) {
							...
							Agility.addExperience(player, 1500 + Misc.getRandom(600));
						} else {
							DialogueManager.start(player, DialogueManager.getDialogues().get(57 + Misc.getRandom(2)));
							player.getInventory().add(2996, 2);
				...
				public void execute() {
					...
					if(player.getPosition().getX() == 2543 && player.getPosition().getY() == 3553) {
						if(Agility.passedAllObstacles(player)) {
								...
								Agility.addExperience(player, 145 + Misc.getRandom(300));
								Agility.resetProgress(player);
			...
			TaskManager.submit(new Task(2, player, false) {
				...
				public void stop() {
					...
					if(Agility.passedAllObstacles(player)) {
							...
							Agility.addExperience(player, 700 + Misc.getRandom(1000));
