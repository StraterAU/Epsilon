...
import com.epsilon.engine.task.impl.HunterTrapsTask;
					...
					if (theTrap.getOwner() == client) {
						if (theTrap instanceof SnareTrap) {
							...
							if (theTrap.getGameObject().getId() == 19180) {
								...
								if(client.getGameMode() == GameMode.EXTREME) {
									client.getSkillManager().addExperience(Skill.HUNTER, (int) (exps[0]*0.25) );
								} else {
								...
								if(client.getGameMode() == GameMode.EXTREME) {
									client.getSkillManager().addExperience(Skill.HUNTER, (int) (exps[1]*0.25) );
								} else {
								...
								if(client.getGameMode() == GameMode.EXTREME) {
									client.getSkillManager().addExperience(Skill.HUNTER, (int) (exps[2]*0.25) );
								} else {
								...
								if(client.getGameMode() == GameMode.EXTREME) {
									client.getSkillManager().addExperience(Skill.HUNTER, (int) (exps[3]*0.25) );
								} else {
								...
								if(client.getGameMode() == GameMode.EXTREME) {
									client.getSkillManager().addExperience(Skill.HUNTER, (int) (exps[4]*0.25) );
								} else {
							...
							if (theTrap.getGameObject().getId() == 19191) {
								...
								if(client.getGameMode() == GameMode.EXTREME) {
									client.getSkillManager().addExperience(Skill.HUNTER, (int) (exps[6]*0.25) );
								} else {
								...
								if(client.getGameMode() == GameMode.EXTREME) {
									client.getSkillManager().addExperience(Skill.HUNTER, (int) (exps[7]*0.25) );
								} else {
						...
						if(random >= 1 && random <= 3) {
							Misc.giveReward(client, Herblore.ITEMS);
						}
						deregister(theTrap);
						client.performAnimation(new Animation(827));
					} else
