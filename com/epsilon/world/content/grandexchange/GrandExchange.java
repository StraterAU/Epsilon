package com.epsilon.world.content.grandexchange;
...
import com.epsilon.model.input.impl.EnterGeQuantity;
import com.epsilon.util.Misc;
import com.epsilon.world.World;
import com.epsilon.world.content.grandexchange.GrandExchangeOffer.OfferType;
...
public class GrandExchange {
	...
	public static void open(Player player) {
		if(player.getGameMode() == GameMode.IRONMAN || player.getGameMode() == GameMode.HARDCORE_IRONMAN || player.hasRights(PlayerRights.ADMINISTRATOR)) {
