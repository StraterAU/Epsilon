package com.epsilon.world.content.combat;
...
import com.epsilon.model.movement.PathFinder;
...
import com.epsilon.world.content.ItemDegrading;
import com.epsilon.world.content.ItemDegrading.DegradingItem;
import com.epsilon.world.content.combat.effect.CombatPoisonEffect;
import com.epsilon.world.content.combat.effect.EquipmentBonus;
import com.epsilon.world.content.combat.effect.CombatPoisonEffect.PoisonType;
import com.epsilon.world.content.combat.magic.CombatAncientSpell;
...
import com.epsilon.world.entity.impl.npc.NPCMovementCoordinator.CoordinateState;
...
public final class CombatFactory {
	...
	/**
	 * Determines if the player is wielding a animal bow.
	 * 
	 * @param player
	 *            the player to determine for.
	 * @return true if the player is wielding a animal bow.
	 */
	public static boolean animalBow(Player player) {
		Item item = player.getEquipment().get(Equipment.WEAPON_SLOT);
		if (item == null)
			return false;
		return item.getId() == 18965;
	}
	...
	protected static void applyPrayerProtection(CombatContainer container, CombatBuilder builder) {
		...
		if(builder.getVictim().isPlayer()) {
			...
			if((victim.getEquipment().getItems()[Equipment.SHIELD_SLOT].getId() == 13738 || victim.getEquipment().getItems()[Equipment.SHIELD_SLOT].getId() == 13740 || victim.getEquipment().getItems()[Equipment.SHIELD_SLOT].getId() == 13742 || victim.getEquipment().getItems()[Equipment.SHIELD_SLOT].getId() == 13744) && !victim.hasRights(PlayerRights.EXTREME_DONATOR) && victim.hasRights(PlayerRights.LEGENDARY_DONATOR) && victim.hasRights(PlayerRights.UBER_DONATOR)) {
			...
			if (container.getCombatType() == CombatType.MAGIC) {
				if(player.getCurrentlyCasting() != null)
					if (player.getExperienceMode() == ExperienceModes.EXTREME)
						player.getSkillManager().addExperience(Skill.MAGIC, (int) (((damage * .90)  * 100) / container.getExperience().length) + builder.getCharacter().getCurrentlyCasting().baseExperience());
				if (player.getExperienceMode() == ExperienceModes.LEGEND)
					player.getSkillManager().addExperience(Skill.MAGIC, (int) (((damage * .90)  * 50) / container.getExperience().length) + builder.getCharacter().getCurrentlyCasting().baseExperience());
				if (player.getExperienceMode() == ExperienceModes.IMMORTAL)
					player.getSkillManager().addExperience(Skill.MAGIC, (int) (((damage * .90)  * 10) / container.getExperience().length) + builder.getCharacter().getCurrentlyCasting().baseExperience());
				if (player.getExperienceMode() == ExperienceModes.GRANDMASTER)
					player.getSkillManager().addExperience(Skill.MAGIC, (int) (((damage * .90)  * 2) / container.getExperience().length) + builder.getCharacter().getCurrentlyCasting().baseExperience());
				if (player.getExperienceMode() == ExperienceModes.IRONMAN)
					player.getSkillManager().addExperience(Skill.MAGIC, (int) (((damage * .90)  * 25) / container.getExperience().length) + builder.getCharacter().getCurrentlyCasting().baseExperience());
				if (player.getExperienceMode() == ExperienceModes.HARDCOREIRONMAN)
					player.getSkillManager().addExperience(Skill.MAGIC, (int) (((damage * .90)  * 5) / container.getExperience().length) + builder.getCharacter().getCurrentlyCasting().baseExperience());
			} else {
				for (int i : container.getExperience()) {
					Skill skill = Skill.forId(i);
					if (player.getExperienceMode() == ExperienceModes.EXTREME)
						player.getSkillManager().addExperience(skill, (int) (((damage * .90)  * 100) / container.getExperience().length));
						if (player.getExperienceMode() == ExperienceModes.LEGEND)
							player.getSkillManager().addExperience(skill, (int) (((damage * .90)  * 50) / container.getExperience().length));
						if (player.getExperienceMode() == ExperienceModes.IMMORTAL)
							player.getSkillManager().addExperience(skill, (int) (((damage * .90)  * 10) / container.getExperience().length));
						if (player.getExperienceMode() == ExperienceModes.GRANDMASTER)
							player.getSkillManager().addExperience(skill, (int) (((damage * .90)  * 2) / container.getExperience().length));
						if (player.getExperienceMode() == ExperienceModes.IRONMAN)
							player.getSkillManager().addExperience(skill, (int) (((damage * .90)  * 25) / container.getExperience().length));
						if (player.getExperienceMode() == ExperienceModes.HARDCOREIRONMAN)
							player.getSkillManager().addExperience(skill, (int) (((damage * .90)  * 5) / container.getExperience().length));
					
				}
			}
			if (player.getExperienceMode() == ExperienceModes.EXTREME)
				player.getSkillManager().addExperience(Skill.CONSTITUTION, (int) (damage * .70) * 35);
				if (player.getExperienceMode() == ExperienceModes.LEGEND)
					player.getSkillManager().addExperience(Skill.CONSTITUTION, (int) (damage * .70) * 20);
				if (player.getExperienceMode() == ExperienceModes.IMMORTAL)
					player.getSkillManager().addExperience(Skill.CONSTITUTION, (int) (damage * .70) * 5);
				if (player.getExperienceMode() == ExperienceModes.GRANDMASTER)
					player.getSkillManager().addExperience(Skill.CONSTITUTION, (int) (damage * .70) * 2);
				if (player.getExperienceMode() == ExperienceModes.IRONMAN)
					player.getSkillManager().addExperience(Skill.CONSTITUTION, (int) (damage * .70) * 10);
				if (player.getExperienceMode() == ExperienceModes.HARDCOREIRONMAN)
					player.getSkillManager().addExperience(Skill.CONSTITUTION, (int) (damage * .70) * 4);
	...
	public static void chargeDragonFireShield(Player player) {
		...
		} else if (player.getDfsCharges() == 20) {
			player.getPacketSender().sendMessage("Your dfs is full.");
			player.incrementDfsCharges(1);
		}
	...
	public static void handleDragonFireShield(final Player player, final Character target) {
		...
		TaskManager.submit(new Task(1, player, false) {
			...
			public void execute() {
				...
				case 4:
					...
					//player.getCombatBuilder().reset(false); //should make it not reset users attack
					target.dealDamage(h);
		...
		int x = player.getDfsCharges();
		player.incrementDfsCharges(-x);
		BonusManager.update(player);
	}
