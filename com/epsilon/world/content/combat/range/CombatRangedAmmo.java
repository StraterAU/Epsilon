package com.epsilon.world.content.combat.range;
...
public class CombatRangedAmmo {
	...
	public enum RangedWeaponData {
		...
		CRYSTAL_BOW(new int[] {4212, 4213, 4214, 4215, 4216, 4217, 4218, 4219, 4220, 4221, 4222, 4223}, new AmmunitionData[] {AmmunitionData.CRYSTAL_BOW}, RangedWeaponType.LONGBOW),
		ANIMAL_BOW(new int[] {18965}, new AmmunitionData[] {AmmunitionData.ANIMAL_BOW}, RangedWeaponType.LONGBOW),
		ZARYTE_BOW(new int[] {19069}, new AmmunitionData[] {AmmunitionData.ZARYTE_BOW}, RangedWeaponType.LONGBOW),
	...
	public enum AmmunitionData {
		...
		CRYSTAL_BOW(new int[] {-1}, 25, 16, 3, 44, 50, 34, 31),
		ANIMAL_BOW(new int[] {11212}, 1111, 1120, 3, 44, 65, 43, 31),
		HAND_CANNON_SHOT(new int[] {15243}, 2138, 2143, 3, 8, 115, 43, 31),
		BOLT_RACK(new int[] {4740}, -1, 27, 3, 33, 70, 43, 31),
		ZARYTE_BOW(new int[] {-1}, 20, 11, 3, 44, 58, 43, 31);
