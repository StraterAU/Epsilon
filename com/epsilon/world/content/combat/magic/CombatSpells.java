package com.epsilon.world.content.combat.magic;
...
public enum CombatSpells {
	...
	BLOOD_RUSH(new CombatAncientSpell() {
		...
		public void spellEffect(Character cast, Character castOn, int damage) {
			...
			if(cast instanceof Player && hasVirtus((Player) cast)) {
				cast.heal(Misc.getRandom(40));
			} else {
	...
	public static boolean hasVirtus(Player player) {
		return player.getEquipment().contains(20159) && player.getEquipment().contains(20163) && player.getEquipment().contains(20167) && player.getEquipment().contains(24980) && player.getEquipment().contains(24986) && player.getEquipment().contains(25062);
	}
