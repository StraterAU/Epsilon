		...
		if(player.getInteractingItem().getId() == 18778) {
			if(checkRequirement(player, skillId, levelReq[0]) && player.getInventory().contains(18778)) {
				...
				if (player.getExperienceMode() == ExperienceModes.EXTREME)
					player.getSkillManager().addExperience(Skill.forId(skillId), exp * 100);
					if (player.getExperienceMode() == ExperienceModes.LEGEND)
						player.getSkillManager().addExperience(Skill.forId(skillId), exp * 50);
					if (player.getExperienceMode() == ExperienceModes.IMMORTAL)
						player.getSkillManager().addExperience(Skill.forId(skillId), exp * 10);
					if (player.getExperienceMode() == ExperienceModes.GRANDMASTER)
						player.getSkillManager().addExperience(Skill.forId(skillId), exp * 2);
					if (player.getExperienceMode() == ExperienceModes.IRONMAN)
						player.getSkillManager().addExperience(Skill.forId(skillId), exp * 25);
					if (player.getExperienceMode() == ExperienceModes.HARDCOREIRONMAN)
						player.getSkillManager().addExperience(Skill.forId(skillId), exp * 5);
