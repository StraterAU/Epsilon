	...
	public static Dialogue getDialogue(Player player) {
		return new Dialogue() {
			...
			public String[] dialogue() {
				return new String[]{"Hello adventurer.", "I have travelled all around Epsilon", "and can tell about the items I've encountered.", "Which item would you like to know about?"};
			}
			...
			public Dialogue nextDialogue() {
				return new Dialogue() {
					...
					@Override
					public String[] dialogue() {
						return new String[]{"Hello adventurer.", "I have traveled all around Epsilon", "and can tell about the items I've encountered.", "Which item would you like to know about?"};
					}
