...
public final class WeaponAnimations {
	...
	public static int getAttackAnimation(Player c) {
		...
		if (weaponName.contains("javelin") || weaponName.contains("thrownaxe")) {
			return 806; // this is the attack anim, ye
		}
		...
		case 16184:
			return 2661;
		//case 5432: // this is the wep id nah i am using it twice in the same thing sec
			//return 2661; //this is the attack animation
		case 16425:
			return 2661;
		case 15241:
			return 12153;
