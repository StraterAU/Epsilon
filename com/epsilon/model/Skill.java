...
public enum Skill {
	...
	public static final int ATTACK_MODIFIER = 100;
	public static final int DEFENCE_MODIFIER = 100;
	public static final int STRENGTH_MODIFIER = 100;
	public static final int CONSTITUTION_MODIFIER = 35;
	public static final int RANGED_MODIFIER = 120;
	public static final int PRAYER_MODIFIER = 10;
	public static final int MAGIC_MODIFIER = 130;
}