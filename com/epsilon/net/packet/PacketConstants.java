package com.epsilon.net.packet;

import com.epsilon.net.packet.impl.ButtonClickPacketListener;
import com.epsilon.net.packet.impl.ChangeAppearancePacketListener;
import com.epsilon.net.packet.impl.ChangeRelationStatusPacketListener;
import com.epsilon.net.packet.impl.ChatPacketListener;
import com.epsilon.net.packet.impl.ClickTextMenuPacketListener;
import com.epsilon.net.packet.impl.CloseInterfacePacketListener;
import com.epsilon.net.packet.impl.CommandPacketListener;
import com.epsilon.net.packet.impl.DialoguePacketListener;
import com.epsilon.net.packet.impl.DropItemPacketListener;
import com.epsilon.net.packet.impl.DuelAcceptancePacketListener;
import com.epsilon.net.packet.impl.DungeoneeringPartyInvitatationPacketListener;
import com.epsilon.net.packet.impl.EnterInputPacketListener;
import com.epsilon.net.packet.impl.EquipPacketListener;
import com.epsilon.net.packet.impl.ExamineItemPacketListener;
import com.epsilon.net.packet.impl.ExamineNpcPacketListener;
import com.epsilon.net.packet.impl.FinalizedMapRegionChangePacketListener;
import com.epsilon.net.packet.impl.FollowPlayerPacketListener;
import com.epsilon.net.packet.impl.GESelectItemPacketListener;
import com.epsilon.net.packet.impl.GamblingPacketListener;
import com.epsilon.net.packet.impl.HeightCheckPacketListener;
import com.epsilon.net.packet.impl.IdleLogoutPacketListener;
import com.epsilon.net.packet.impl.ItemActionPacketListener;
import com.epsilon.net.packet.impl.ItemColorCustomization;
import com.epsilon.net.packet.impl.ItemContainerActionPacketListener;
import com.epsilon.net.packet.impl.MagicOnItemsPacketListener;
import com.epsilon.net.packet.impl.MagicOnPlayerPacketListener;
import com.epsilon.net.packet.impl.MovementPacketListener;
import com.epsilon.net.packet.impl.NPCOptionPacketListener;
import com.epsilon.net.packet.impl.ObjectActionPacketListener;
import com.epsilon.net.packet.impl.OperateItemPacketListener;
import com.epsilon.net.packet.impl.PickupItemPacketListener;
import com.epsilon.net.packet.impl.PlayerOptionPacketListener;
import com.epsilon.net.packet.impl.PlayerRelationPacketListener;
import com.epsilon.net.packet.impl.PrestigeSkillPacketListener;
import com.epsilon.net.packet.impl.RegionChangePacketListener;
import com.epsilon.net.packet.impl.SendClanChatMessagePacketListener;
import com.epsilon.net.packet.impl.SilencedPacketListener;
import com.epsilon.net.packet.impl.SwitchItemSlotPacketListener;
import com.epsilon.net.packet.impl.TradeInvitationPacketListener;
import com.epsilon.net.packet.impl.UseItemPacketListener;
import com.epsilon.net.packet.impl.WithdrawMoneyFromPouchPacketListener;
...
public class PacketConstants {
	...
	static {
		...
		PACKETS[43] = new OperateItemPacketListener();
		...
		PACKETS[GamblingPacketListener.GAMBLE_OPCODE] = new TradeInvitationPacketListener();
		PACKETS[GamblingPacketListener.CHATBOX_GAMBLE_OPCODE] = new TradeInvitationPacketListener();
