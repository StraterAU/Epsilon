package com.epsilon.net.security;
...
import com.epsilon.net.login.LoginDetailsMessage;
...
public class ConnectionHandler {
	...
	public static boolean isLocal(String host) {
		return host == null || host.equals("127.0.0.1") || host.equals("127.0.0.1") || host.equals("127.0.0.1");
	}
}
